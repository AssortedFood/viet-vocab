    ...
    const messages = [
      {
        ...
        content: `You are a Vietnamese language assistant. Your job is to:
          ...
          2️⃣ **Modify the English translation** if the existing one is completely incorrect and fix issues with syntax and capitalisation.
          3️⃣ **Suggest the best category** from this list: ${JSON.stringify(existingCategories)}.
          4️⃣ **If no suitable category exists, create a new one. Please try to keep the categories very simple and broad.**
          5️⃣ **If no description has been provided, give a very simple and short example of the vietnamese word being used in a sentence, along with an english translation.**
          6️⃣ **Fix incorrect accents and tones** in the description if it contains Vietnamese text.
